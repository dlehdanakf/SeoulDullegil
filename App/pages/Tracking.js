...
import {
    ...
    Platform, TouchableNativeFeedback, StatusBar, Dimensions
} from 'react-native';
...
export default class Tracking extends React.Component {
    ...
    startTracking() {
      Notifications.presentLocalNotificationAsync({title: '트래킹 시작', body: this.state.mapData.NAME+' 트래킹 진행중~.', sticky: true});
      this.setState({
        ...
        return (
            <View style={styles.fill}>
                ...
                <Drawer
                    ...
                    type="overlay"
                    content={<TrackingInfo courseName={this.state.mapData.NAME} walkingTime = {this.state.walkingTime} walkingDistance={this.state.walkingDistance} nearSpot={this.state.nearSpot}/>}
                    openDrawerOffset={(viewport) => viewport.height - 270}  /* 사이드바 크기 조절 */
                    closedDrawerOffset={40}
                    styles={{main: {shadowColor: "#000000", shadowOpacity: 1, shadowRadius: 0}}}
                ...
                <View style={{position:'absolute', zIndex:-1, bottom:0, height: 100, width: Dimensions.get('window').width, backgroundColor: '#0C181C'}}/>
